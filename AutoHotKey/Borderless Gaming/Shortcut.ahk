...
; ---- SCRIPT
; 1. Ejecuta BorderlessGaming.exe si no está arrancado
Process, Exist, BorderlessGaming.exe ; check to see if BorderlessGaming.exe is running
If (ErrorLevel = 0) ; If it is not running
{
	Run BorderlessGaming.exe
}
